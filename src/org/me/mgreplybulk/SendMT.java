 ...
 *         &lt;element name="arg2" type="{http://MGReplyBulk.me.org/}sendMTStruct" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class SendMT {
    ...
    protected List<SendMTStruct> arg2;
     ...
     * 
     */
    public List<SendMTStruct> getArg2() {
        if (arg2 == null) {
            arg2 = new ArrayList<SendMTStruct>();
        }
        return this.arg2;
    }
