 ...
 * generated in the org.me.mgreply package. 
...
public class ObjectFactory {
    ...
    private final static QName _SendNotification_QNAME = new QName("http://MGReply.me.org/", "sendNotification");
    private final static QName _SendMTResponse_QNAME = new QName("http://MGReply.me.org/", "sendMTResponse");
    private final static QName _SendMessage_QNAME = new QName("http://MGReply.me.org/", "sendMessage");
    private final static QName _SendNotificationResponse_QNAME = new QName("http://MGReply.me.org/", "sendNotificationResponse");
    private final static QName _SendMT_QNAME = new QName("http://MGReply.me.org/", "sendMT");
    private final static QName _SendMessageResponse_QNAME = new QName("http://MGReply.me.org/", "sendMessageResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.me.mgreply
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MGReply.me.org/", name = "sendNotification")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MGReply.me.org/", name = "sendMTResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MGReply.me.org/", name = "sendMessage")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MGReply.me.org/", name = "sendNotificationResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MGReply.me.org/", name = "sendMT")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://MGReply.me.org/", name = "sendMessageResponse")
